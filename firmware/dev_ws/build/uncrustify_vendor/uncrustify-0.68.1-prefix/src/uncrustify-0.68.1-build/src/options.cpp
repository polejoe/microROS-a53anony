...
BoundedOption<unsigned, 0, 256> code_width = {
  "code_width",
  u8R"__(
...
BoundedOption<unsigned, 0, 5000> align_func_params_thresh = {
...
BoundedOption<unsigned, 0, 5000> align_same_func_call_params_thresh = {
...
BoundedOption<unsigned, 0, 5000> align_var_def_thresh = {
...
BoundedOption<unsigned, 0, 5000> align_assign_thresh = {
  "align_assign_thresh",
  u8R"__(
...
BoundedOption<unsigned, 0, 5000> align_enum_equ_thresh = {
...
BoundedOption<unsigned, 0, 5000> align_var_class_thresh = {
...
BoundedOption<unsigned, 0, 5000> align_var_struct_thresh = {
